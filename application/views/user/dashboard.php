...
<head>
    ...
    <style type="text/css">
        ...
        .teal-blue {
            background: #68a3a5 !important;
            border-color: #68a3a5 !important;
        }
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="" style="width:100%;">
                <img style="height:45px;max-width:100%;margin:15px 0 0 0;"
                     src="<?php echo base_url(); ?>assets/user/images/verify_rocket_logo_small.png" alt="logo"
                     class="logo-default"/>
                        ...
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <img alt="" class="img-circle"
                                 src="<?php echo base_url() . $this->session->email_lookup_user_avater; ?>">
                            <span
                                class="username username-hide-mobile"><?php echo $this->session->email_lookup_user_username; ?></span>
                        </a>
