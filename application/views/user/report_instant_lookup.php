        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                <table class="table">
                    <tr>
                        <td>From :</td>
                        <td><input id="expense_from_date" type="text" class="form-control date-picker"
                                   data-date-picker="yyyy-mm-dd" placeholder="Select Date From"></td>
                    </tr>
                    <tr>
                        <td>To :</td>
                        <td><input id="expense_to_date" type="text" class="form-control date-picker"
                                   placeholder="Select Date To"></td>
                    </tr>
                </table>
            </div>
        </div>
