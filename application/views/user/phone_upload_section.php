...
<div class="col-xs-12">
        ...
        <p>&nbsp;</p>
                        ...
                        <div class="col-xs-12" >
                            ...
                            <form class="" id="contact_upload_form<?php //if($dash_profile['username'] == 'mohiolmis') echo 'contact_upload_for'; else echo 'contact_upload_form'; ?>" action="<?php echo base_url();?>upload_phone_file" method="POST" enctype="multipart/form-data">
                                <!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
                                <div class="col-xs-12 nopadding fileupload-buttonbar">
                                    <!--<div class="col-xs-12 text-center" style="font-size:130%;color:red;margin-bottom:20px;">
                                        Email should be present at first column in CSV file.
