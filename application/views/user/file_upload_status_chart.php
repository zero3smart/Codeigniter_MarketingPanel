        ...
        <div class="col-xs-12">
        	<p>&nbsp;</p>
        	<h4 class="text-center">Demograph of <span style="color:#27a4b0" id="chart_file_name"><?php echo $file_status_value_value['file_name'];?></span></h4>
        	<p>&nbsp;</p>
        </div>
                                                                                        ...
                                                                                        <div class="col-xs-12">
                                                                                            <div class="col-xs-6 col-md-3 nopadding">
                                                                                                <div class="btn  purple col-xs-12">Total Contacts : <span id="chart_total"><?php echo $file_status_value_value['total_contacts'];?></span></div>
                                                                                            </div>
                                                                                            <div class="col-xs-6 col-md-3 nopadding">
                                                                                                <div class="btn  blue col-xs-12">Successful : <span id="chart_successful"><?php echo $file_status_value_value['total_successful'];?></span></div>
                                                                                            </div>
                                                                                            <div class="col-xs-6 col-md-3 nopadding">
                                                                                                <div class="btn  dark col-xs-12">Failed : <span id="chart_failed"><?php echo $file_status_value_value['total_failed'];?></span></div>
                                                                                            </div>
																							<div class="col-xs-6 col-md-3 nopadding">
                                                                                                <div class="btn  green col-xs-12">Invalid : <span id="chart_invalid"><?php echo $file_status_value_value['total_invalid'];?></span></div>
                                                                                            </div>
