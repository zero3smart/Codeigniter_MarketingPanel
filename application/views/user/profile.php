		...
		echo '
			...
			<tr><td class="text-right td_1">
				...
				<td class="custom_edit td_2" data_field="username">
					...
					<form class="custom_edit_single_field_form">
						...
						<div class="col-xs-12 form_element">
							<input class="form-control" style="" value="'.(isset($profile_document['contact']) ? $profile_document['contact'] : "").'" name="field_value">
							<input type="hidden" value="user" name="collection">
			...
			<tr><td class="text-right td_1">
				...
				<td class="custom_edit td_2" data_field="username">
					...
					<form class="custom_edit_single_field_form">
						<div class="col-xs-12 field_element">
							<span class="value">'.(isset($profile_document['state']) ? $profile_document['state'] : "").'</span>
							<i class="fa fa-pencil pull_field_form"></i>
						</div>
						<div class="col-xs-12 form_element">
							<input class="form-control" style="" value="'.(isset($profile_document['state']) ? $profile_document['state'] : "").'" name="field_value">
							<input type="hidden" value="user" name="collection">
			...
			<tr><td class="text-right td_1">
				...
				<td class="custom_edit td_2" data_field="username">
					...
					<form class="custom_edit_single_field_form">
						<div class="col-xs-12 field_element">
							<span class="value">'.(isset($profile_document['country']) ? $profile_document['country'] : "").'</span>
							<i class="fa fa-pencil pull_field_form"></i>
						</div>
						<div class="col-xs-12 form_element">
							<input class="form-control" style="" value="'.(isset($profile_document['country']) ? $profile_document['country'] : "").'" name="field_value">
							<input type="hidden" value="user" name="collection">
