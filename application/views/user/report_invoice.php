        ...
        <div class="portlet box green">
            <div class="portlet-title">
                ...
                <div class="pull-right">
                    <a class="btn dark" data-toggle="modal" href="#date_range_modal" style="margin:3px 5px 0 15px;">Search
                        by Date</a>
                </div>
                <div class="caption pull-right">Total Cost : $ <?php echo $expense_price_sum; ?> </div>
                <!-- <div class="tools"> </div> -->
            </div>
            <div class="portlet-body" id="group_list">
                <div class="table-responsive">
                    <table class="table_all_center table table-bordered table-striped table-condensed flip-content"
                           width="100%" style="word-break:break-all;" id="" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th>Serail</th>
                            <th>Invoice ID</th>
                        ...
                        foreach ($expense_details as $expense_details_key => $expense_details_value) {
                            ...
                            $type = "";
                            $date_array = array();
                            if ($expense_details_value['datetime'] != "") {
                                $date_array = explode(" ", $expense_details_value['datetime']);
                                $date = date('F j, Y, g:i a', $date_array[1]);
                            }
                            echo '
                                                    <tr>
                                                        <td>' . $serial . '</td>
                                                        <td>' . $expense_details_value['invoice_id'] . '</td>
                                                        <td>' . $expense_details_value['price'] . '</td>
                                                        <td>' . $expense_details_value['credit'] . '</td>
                                                        <td>' . $expense_details_value['description'] . '</td>
                                                        <td>' . $date . '</td>
                                                        <td>
                                                        	<a class="btn green" target="_blank" href="' . base_url() . 'download_invoice/' . $expense_details_value['_id'] . '" data-href="#view_invoice_' . $expense_details_value['_id'] . '">DOWNLOAD</a>
                                                        	                                                        </td>
                                                    </tr>
                                                    ';
                        }
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                <table class="table">
                    ...
                    <tr>
                        <td>From :</td>
                        <td><input id="report_action_from_date" type="text" class="form-control date-picker"
                                   data-date-picker="yyyy-mm-dd" placeholder="Select Date From"></td>
                    </tr>
                    <tr>
                        <td>To :</td>
                        <td>
                            <input id="report_action_to_date" type="text" class="form-control date-picker"
                                   placeholder="Select Date To">
                            <input id="report_action_url" type="hidden"
                                   value="<?php echo base_url(); ?>report/invoice_by_date/">
