...
<style type="text/css">
    ...
    .dashboard-stat.line>.visual,.dashboard-stat.line>.more{padding-left:25px;}
    .dashboard-stat.line>.bar{position:absolute;top:0;left:0;height:100%;width:8px;z-index:10;}
    .dashboard-stat.red-c{border-left:8px solid #e7505a;}.dashboard-stat.red-c .visual .fa{color:#e7505a;opacity:.2;}
    .dashboard-stat.blue-c{border-left:8px solid #3598dc;}.dashboard-stat.blue-c .visual .fa{color:#3598dc;opacity:.2;}
    .dashboard-stat.green-c{border-left:8px solid #32c5d2;}.dashboard-stat.green-c .visual .fa{color:#32c5d2;opacity:.2;}
    .dashboard-stat.purple-c{border-left:8px solid #8E44AD;}.dashboard-stat.purple-c .visual .fa{color:#8E44AD;opacity:.2;}
    ...
    <div class="col-xs-12 nopadding">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat purple-c white line">
                ...
                <div class="details">
                    <div class="number">
                        <span data-value="12,5" data-counter="counterup"><?php echo $count_processing_user_file;?></span> </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat red-c white line">
                ...
                <div class="details">
                    <div class="number">
                        <span data-value="12,5" data-counter="counterup"><?php echo $file_summery_all['preclean_records'];?></span> </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat green-c white line">
                ...
                <div class="details">
                    <div class="number">
                        <span data-value="12,5" data-counter="counterup"><?php echo $file_summery_all['clean_records'];?></span> </div>
    ...
    <div class="col-xs-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>File Clean up Demograph <?php if($total_graph_data_sum == 0) echo '( No Data Found to show in Graph )'; ?>
                </div>
            </div>
