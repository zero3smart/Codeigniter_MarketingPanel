...
?>
    ...
    <script type="text/javascript">
        ...
        <?php
        if ($view['menu'] != '') {
            echo '$(".menu_' . $view['menu'] . '").addClass("active").addClass("open");$(".menu_' . $view['menu'] . '>a>.arrow").addClass("open");';
        }
        if ($view['submenu'] != '') {
            echo '$(".submenu_' . $view['submenu'] . '").addClass("active").addClass("open");';
        }
        ?>
    </script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $form.submit(function (event) {
                ...
                if (isNaN(price_during_buy)) price_during_buy = 0;
