<link href="http://54.187.223.58/carrier_lookup/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<style type="text/css">
    
    .wrapper{margin:0 auto;width:1000px;}
    #container{position:relative;width:100%;float:left;background:#fff;font-size:120%;font-weight:bold;}
    .conatiner_wrapper,.conatiner_wrapper_2{position:relative;width:100%;float:left;}
    .conatiner_wrapper{margin:30px 0;box-shadow:0px 0px 15px rgba(0,0,0,.5);}
    .conatiner_wrapper_2{margin-bottom:50px;}
    .f2,b{font-size:140%;}
    .table th{font-size:120%;font-weight:bold;}
    .table td{font-size:100%;font-weight:bold;}
    .row-even{background:#F8F7F7;}
