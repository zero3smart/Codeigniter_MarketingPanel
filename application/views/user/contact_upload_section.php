...
<link href="<?php echo base_url(); ?>assets/global/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet"
      type="text/css"/>
<link href="<?php echo base_url(); ?>assets/global/plugins/jquery-file-upload/blueimp-gallery/blueimp-gallery.min.css"
      rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url(); ?>assets/global/plugins/jquery-file-upload/css/jquery.fileupload.css"
      rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url(); ?>assets/global/plugins/jquery-file-upload/css/jquery.fileupload-ui.css"
      rel="stylesheet" type="text/css"/>
...
<style type="text/css">
    .drop_area {
        ...
        transition: .5s;
        box-shadow: 0px 0px 0px rgba(0, 0, 0, .5), 0px 0px 0px rgba(0, 0, 0, .1) inset;
    }

    .drop_area:hover, .drop_area.mouse-over:hover {
        background: rgba(3, 167, 214, .1);
        transition: .5s;
        box-shadow: 0px 0px 10px rgba(0, 0, 0, .2), 0px 0px 50px rgba(0, 0, 0, .01) inset;
    }

    .drop_area.mouse-over {
        background: rgba(3, 167, 214, .3);
        transition: .5s;
        box-shadow: 0px 0px 10px rgba(0, 0, 0, .5), 0px 0px 50px rgba(0, 0, 0, .03) inset;
    }
    ...
    #instant_check_field_respose_con {
...
<div class="col-xs-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div id="button_collapse" class="scrub-status-container expanded-button"
                 onclick="toggleCollapse('file_process_progress_container', 'button_collapse')">&nbsp;</div>
            <div class="caption">
                ...
                <div class="search-page search-content-2  nopadding">
                    <div class="search-bar">
                        <div class="row">
                            <div class="col-md-12">
                                <!--<form id="instant_check_form" action="<?php /*echo base_url();*/ ?>sendInstantCheckupRequest" method="post">-->
                                <form id="instant_check_form" action="http://205.134.243.198:3001/search"
                                      method="GET">
                                    <div class="input-group">
                                        <input type="email" id="instant_check_field" required name="email"
                                               class="form-control"
                                               placeholder="Enter email . . . (Example1@domain.com)">
                                            <span class="input-group-btn">
                                              <button class="btn dark bold instant_check_btn submit_btn"
                                                      type="submit">CHECK
                                              </button>
                                    </span>
                                    </div>
...
<form class=""
      id="contact_upload_form<?php //if($dash_profile['username'] == 'mohiolmis') echo 'contact_upload_for'; else echo 'contact_upload_form'; ?>"
      action="<?php echo base_url(); ?>upload_file" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-xs-12">
            ...
            <div id="drop-zone" class="drop_area">
                ...
                <div id="clickHere">
                    <i class="fa fa-plus"></i>
                    <span> Browse File... </span>
                    <input name="contactfile" id="contact_upload_file"
                           onchange="fn_contact_upload_file_name_set(event)" type="file" accept=".txt,.csv">
                    <input type="hidden" name="upload_dir" id="upload_dir" value="/dirty/"/>
                </div>
            </div>
            <!--<![endif]-->
    ...
    <div class="col-xs-12 " style="display:none;" id="show_contacts_status_at_file">
        ...
        <div class="note note-danger col-xs-12" style="margin:0;">
            <div class="col-xs-12" style="padding:0;">
                ...
                <div class="col-xs-3">
                    <input type="number" required value="" name="column_number" class="form-control col-xs-12"
                           id="set_column_number">
                    <input value="1" name="column_number_2" type="hidden" id="set_column_number_2">
                    <input value="\n" name="line_break" type="hidden" id="line_break">
                </div>
                <div class="col-xs-3 text-left">
                    <a class="btn yellow" href="#" id="get_column_number" onclick="fn_contact_upload_file()">Change</a>
                </div>
...
<style type="text/css">
    .file_progress_wrapper {
        ...
        width: 350px;
        height: 150px;
        border-bottom: 3px solid #0E848E !important;
        overflow: hidden;
    }
    ...
    .file_progress_up .file_progress_circle, .file_progress_down .file_progress_circle {
        position: absolute;
        float: left;
        left: 0;
        width: 100%;
    ...
    .file_progress_up .file_progress_circle {
        top: 0;
        background: #fff;
        border: 3px solid #26a1ab;
    }

    .file_progress_down .file_progress_circle {
        top: -150px;
        background: #26a1ab;
    ...
    .file_progress_row .file_data {
        text-align: center;
        font-size: 100%;
    }

    .file_progress_row .icon {
        font-size: 60px;
        border: none;
        color: rgba(0, 0, 0, 1);
        text-align: center;
