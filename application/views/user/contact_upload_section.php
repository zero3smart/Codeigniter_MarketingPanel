    ...
    <div class="col-xs-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div id="button_collapse" class="scrub-status-container collapsed-button" onclick="toggleCollapse('file_process_progress', 'button_collapse')" style="display: none"> + </div>
                <div class="caption">
