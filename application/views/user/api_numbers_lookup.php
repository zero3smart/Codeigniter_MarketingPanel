<div class="row">
    <div class="col-xs-12">
        ...
        <div class="note note-info">
            ...
            <p> This is a POST Method HTTP API. This API used for Check Valid or Invalid number,carrier,country,city
                etc. Copy this code and write a html file. Please Write YOUR_API_KEY( <b
                    style="color:#3d3d3d"><?php echo $dash_profile['api_key']; ?></b> ) and Write a Email. When you run
                this api you will get a Response. Like below
                <br><br>
