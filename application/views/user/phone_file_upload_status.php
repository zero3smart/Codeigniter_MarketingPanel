...
<div class="row">
    ...
    foreach ($file_status as $file_status_key => $file_status_value) {
        foreach ($file_status_value as $file_status_value_key => $file_status_value_value) {
            ...
            $reports[]= array('reportName' => 'Total Clean Numbers', 'numOfRecords' => ($summary['totalRecordsAfterClean']));
            $reports[]= array('reportName' => 'Total Failed Numbers', 'numOfRecords' => ($summary['totalInvalid']));
            ...
            if ($validation_chart_data_counter % 2 == 0) {
                ...
                echo '
                                        ...
                                        <!--<div class="col-xs-12" style="padding-bottom:5px;">
                                            <a class="btn green col-xs-12" href="' . base_url() . 'report_file_download/' . $file_status_value_value['_id'] . '"><i class="fa fa-download"></i>  Report File Download</a>
                                        </div>-->
                                        <div class="col-xs-12">
